...
if (msg_type === "text") {
  ...
  text = `[${msg_type} received - media handling pending]`;
}
...
const convResult = await pool.query(
  `
  INSERT INTO conversations (contact_id, status, last_message_at, unread_count)
  VALUES ($1, 'OPEN', NOW(), 1)
...
await pool.query(
  `
  INSERT INTO messages (conversation_id, direction, msg_type, text, wa_message_id, raw_payload)
  VALUES ($1, 'inbound', $2, $3, $4, $5);
  `,
  [conversation_id, msg_type, text, wa_message_id, body]
);

console.log("Saved message:", { wa_id, conversation_id, msg_type });
